...
#Import-LocalizedData -BindingVariable localizationString -FileName C:\Windows\diagnostics\CL_LocalizationData
...
namespace ThemeApi
{
    ...
    public static class ThemeManagerHelpClass
    {
        ...
        public class ThemeManagerClass : IThemeManager, ThemeManager
        {
            ...
            [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
            public virtual extern void ActivateTransparency();
        ...
        [PermissionSet(SecurityAction.LinkDemand)]
        public static void ActivateTransparency()
        {
            themeManager.ActivateTransparency();
        }
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                else if (String.Compare(methodName, "activatetransparency") == 0)
                {
